				...
				<form method="post" action="/codeGroup/codeGroupInst" id="regCodeGroupForm" name="regCodeGroupForm">
					...
					<H1>코드 그룹 관리</H1>
						<div class="col-sm-5 gy-4 offset-1">
							...
							<input type="text" class="form-control" id="CGSeq" placeholder="자동생성" disabled>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-5 gy-4 offset-1">
							<label for="CGNameKor">코드그룹 이름(한글)</label>
							<input type="text" class="form-control" id="CGNameKor" name="CGNameKor" value="<c:out value="${dto.CGNameKor }"/>" placeholder="한글, 숫자">
						</div>
						<div class="col-sm-5 gy-4">
							<label for="CGNameEng">코드그룹 이름(영문)</label>
							<input type="text" class="form-control" id="CGNameEng" name="CGNameEng" value="<c:out value="${dto.CGNameEng }"/>" placeholder="영문(대소문자), 숫자">
						</div>
					</div>
					<div class="row">
						<div class="col-sm-5 gy-4 offset-1">
						...
						<div class="col-sm-5 gy-4">
							...
							<input type="text" class="form-control" id="CGOrder" name="CGOrder" value="<c:out value="${dto.CGOrder }"/>" placeholder="숫자">
						</div>
					</div>
					<div class="row">
						<div class="col-sm-5 gy-4 offset-1">
					...
					<div class="row">
						<div class="col-sm-5 gy-4 offset-1">
							...
							<input type="text" class="form-control" id="CGRegistration" name="CGRegistration" value="<c:out value="${dto.CGRegistration }"/>" placeholder="등록일">
						</div>
					</div>
