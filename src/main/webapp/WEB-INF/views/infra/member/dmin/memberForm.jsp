		...
		<div class="container-fluid">
			<div class="row" style="padding-left: 20px; padding-right: 20px;">
				...
				<div class="col-lg-10">
					...
					<div class="row">
						<div class="col-sm-5 gy-4 offset-1">
							<label for="codeCode">아이디</label>
							<input type="text" class="form-control" id="codeCode">
						</div>
						<div class="col-sm-5 gy-4">
							<label for="codeCodeAnother">비밀번호</label>
							<input type="text" class="form-control" id="codeCodeAnother" placeholder="영문(대소문자),숫자">
						</div>
					</div>
					<div class="row">
						<div class="col-sm-5 gy-4 offset-1">
							<label for="codeNameKor">이름</label>
							<input type="text" class="form-control" id="codeNameKor" placeholder="한글, 숫자">
						</div>
						<div class="col-sm-5 gy-4">
							<label for="codeNameEng">닉네임</label>
							<input type="text" class="form-control" id="codeNameEng" placeholder="영문(대소문자), 숫자">
						</div>
					</div>
					<div class="row">
						<div class="col-sm-5 gy-4 offset-1">
							...
							<input type="radio" class="col-sm-1" id="regGenderWoman" name="regGender" value="woman">
							<label for="regGenderWoman">남성</label>
							<input type="radio" class="col-sm-1" id="regGenderWoman" name="regGender" value="woman">
							<label for="regGenderWoman">여성</label>
						</div>
						<div class="col-sm-5 gy-4">
							<label for="codeSequence">생일</label>
							<input type="text" class="form-control" id="codeSequence" placeholder="숫자">
						</div>
						
					</div>
					<div class="row">
						<div class="col-sm-5 gy-4 offset-1">
							<label for="codeExplanation">휴대폰 번호</label>
							<input type="text" class="form-control" id="codeExplanation" name="codeExplanation" placeholder="숫자">
						</div>
						<div class="col-sm-5 gy-4">
							<label for="codeExplanation">집전화 번호</label>
							<input type="text" class="form-control" id="codeExplanation" name="codeExplanation" placeholder="숫자">
						</div>
					</div>
					<div class="row">
						<div class="col-sm-5 gy-4 offset-1">
							<label for="codeSpareVarchar1">이메일</label>
							<input type="text" class="form-control" id="codeSpareVarchar1" placeholder="영문(대소문자), 숫자">
						</div>
						<div class="col-sm-5 gy-4">
							<label for="codeSpareVarchar2">우편번호</label>
							<input type="text" class="form-control" id="codeSpareVarchar2" placeholder="영문(대소문자), 숫자">
						</div>
					</div>
					<div class="row">
						<div class="col-sm-5 gy-4 offset-1">
							<label for="codeSpareInt1">주소</label>
							<input type="text" class="form-control" id="codeSpareInt1" placeholder="숫자">
						</div>
						<div class="col-sm-5 gy-4">
							<label for="codeSpareInt2">상세주소</label>
							<input type="text" class="form-control" id="codeSpareInt2" placeholder="숫자">
						</div>
					</div>
					<div class="row">
						<div class="col-sm-5 gy-4 offset-1">
                            ...
                            <input type="radio" class="col-sm-1" id="regPrivacy1" name="regPrivacy" value="1">
                            <label for="regPrivacy1">1년</label>
                       
                            <input type="radio" class="col-sm-1" id="regPrivacy2" name="regPrivacy" value="2">
                            <label for="regPrivacy2">3년</label>
                        
                            <input type="radio" class="col-sm-1" id="regPrivacy3" name="regPrivacy" value="3">
                            <label for="regPrivacy3">5년</label>
                 
                            <input type="radio" class="col-sm-1" id="regPrivacy4" name="regPrivacy" value="4">
					...
					<div class="row">
						<div class="col-sm-5 gy-4 offset-1"
							...
							<input type="text" class="form-control" id="codeSpareInt3" placeholder="숫자" disable>
						</div>
					</div>
