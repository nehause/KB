...
<!-- start -->
		...
		<form method="post" id="TLForm" name="TLForm" class="d-flex" role="search">
					...
					<div class="col-lg-10">
						...
						<div class="row">
							<div class="col">
								...
								<div>
									<div style="float: left;">
										<button type="button" class="btn btn-danger" name="transportTableDelect" id="transportTableDelect" data-bs-toggle="modal" data-bs-target="#transportTableDelectModal">
											<i class="fa-solid fa-trash"></i> 삭제
										</button>
										<button type="button" class="btn btn-outline-danger" id="transportListDelect" data-bs-toggle="modal" data-bs-target="#transportListDelectModal">
									...
									<div class="modal fade" id="transportTableDelectModal" tabindex="-1" aria-labelledby="transportTableDelectLabel" aria-hidden="true">
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="transportTableDelectLabel">테이블에서 삭제하시겠습니까?</h5>
									...
									<div class="modal fade" id="transportListDelectModal" tabindex="-1" aria-labelledby="transportListDelectLabel" aria-hidden="true">
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="transportListDelectLabel">리스트에서 삭제하시겠습니까?</h5>
													<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
												</div>
												<div class="modal-body">
