	                    ...
	                    <div class="card mb-sm-3 mb-md-0 contacts_card">
	                        <div class="card-header">
	                            <div class="input-group">
									<input type="text" placeholder="add ChatUser Seq..." id="chatUserMemberSeq" name="chatUserMemberSeq" class="form-control search">
										...
										<li class="room" id="${list.chatSeq}" onclick="selectChatRoom(${list.chatSeq})" style="cursor: pointer;">
		                                    <div class="d-flex bd-highlight">
		                                        ...
		                                        <div class="chat_product_info">
		                                            ...
		                                            <span class="status"><c:out value="${list.userName }"/></span>
                                 					<p>TEST TEXT FIELD</p>
		                                        </div>
		                                    </div>
		                                </li>
	...
	<script>
		...
		addChat = function(){
					...
					$.ajax({
						...
						,datatype:'json'
						,data:{
							chatUserMemberSeq : $("#chatUserMemberSeq").val()
						}
						,success:function(result){
							if(result.rt=="success"){
								
								$("#chatUserMemberSeq").val("");
								var txt="";
