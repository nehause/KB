...
<!-- start -->
		...
		<form method="post" id="OLForm" name="OLForm" class="d-flex" role="search">
					...
					<div class="col-lg-10">
						...
						<div class="row">
							<div class="col">
								...
								<div>
									<div style="float: left;">
										<button type="button" class="btn btn-danger" name="orderTableDelect" id="orderTableDelect" data-bs-toggle="modal" data-bs-target="#orderTableDelectModal">
											<i class="fa-solid fa-trash"></i> 삭제
										</button>
										<button type="button" class="btn btn-outline-danger" id="orderListDelect" data-bs-toggle="modal" data-bs-target="#orderListDelectModal">
									...
									<div class="modal fade" id="orderTableDelectModal" tabindex="-1" aria-labelledby="orderTableDelectLabel" aria-hidden="true">
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="orderTableDelectLabel">테이블에서 삭제하시겠습니까?</h5>
									...
									<div class="modal fade" id="orderListDelectModal" tabindex="-1" aria-labelledby="orderListDelectLabel" aria-hidden="true">
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="orderListDelectLabel">리스트에서 삭제하시겠습니까?</h5>
													<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
												</div>
												<div class="modal-body">
